...
- `tests/e2e.js`: 61 → **87 assertions**, now covering git-block drift and restore, the ignore rules themselves, the button-contrast invariant, and both dynamic i18n key families.
