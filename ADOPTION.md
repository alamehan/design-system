...
_Generated 2026-07-28 against design system v3.3.0. Read from committed `.ds/manifest.json` files — no telemetry._
...
|---|---|
| Repos adopted | **0** |
| Distinct developers | **0** |
| Installs / updates / uninstalls | 0 / 0 / 0 |
| Change requests raised | 0 |
| Adoption level | — |
