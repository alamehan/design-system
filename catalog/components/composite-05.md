...
**Reference (DERIVED — pending design review):** `reference/gallery.html#file-upload`  — built from this spec’s own tokens and anatomy, token-pure and gate-clean, but NOT yet checked against Figma. Safe to build on; expect the designer to adjust layout details.
