...
**Reference:** this spec is an ASSET INVENTORY, not a component — the truth is the files in `src/assets/option-menus/`. See the **Files:** coverage line above and reference an asset by path; never invent a filename.
...
**Reference:** this spec is an ASSET INVENTORY, not a component — the truth is the files in `src/assets/character-expressions/` (not exported yet). See the **Files:** coverage line above and reference an asset by path; never invent a filename.
...
**Reference:** this spec is an ASSET INVENTORY, not a component — the truth is the files in `src/assets/animated-illustrations/` (not exported yet). See the **Files:** coverage line above and reference an asset by path; never invent a filename.
...
**Reference:** this spec is an ASSET INVENTORY, not a component — the truth is the files in `src/assets/complex-illustrations/` (not exported yet). See the **Files:** coverage line above and reference an asset by path; never invent a filename.
...
**Files:** none needed — icons render from `@iconify-json/tabler` as `i-tabler-<name>` classes (prepend your repo's Tailwind prefix if it has one, e.g. `tw-i-tabler-<name>`).
**Reference:** this spec is an ASSET INVENTORY, not a component — the truth is the files in `src/assets/icons-tabler-extended/` (not exported yet). See the **Files:** coverage line above and reference an asset by path; never invent a filename.
...
**Reference:** this spec is an ASSET INVENTORY, not a component — the truth is the files in `src/assets/logos/` (not exported yet). See the **Files:** coverage line above and reference an asset by path; never invent a filename.
...
**Reference:** `reference/components/input.html` · `reference/gallery.html#input` · `reference/components/textarea.html` · `reference/gallery.html#textarea`  — copy the structure and class names from here; it is token-pure and spec-true.
...
**Reference:** `reference/components/checkbox.html` · `reference/gallery.html#checkbox` · `reference/components/radio.html` · `reference/gallery.html#radio` · `reference/components/switch.html` · `reference/gallery.html#switch`  — copy the structure and class names from here; it is token-pure and spec-true.
...
**Tokens:** spacing.standard.lg  — class per token: see Token vocabulary
**Reference (DERIVED — NOT design-reviewed · REFERENCE ONLY):** `reference/gallery.html#candidate-details-panel`  — built from this spec’s own tokens and anatomy: token-pure, on the type ramp and gate-clean, but never checked against Figma, so its layout choices are guesses rather than decisions. **Ground on the spec above first.** Copy from the rendering ONLY where it agrees with what this spec actually states; where the spec is silent prefer a reviewed component from the escalation ladder (CLAUDE.md §2) over anything invented in it; where the two disagree the SPEC WINS and the difference goes to the design system author. Never describe work built on this as design-approved. In `reference/gallery.html` it lives in Part 3, closed by default.
...
**Tokens:** spacing.standard.lg  — class per token: see Token vocabulary
**Reference (DERIVED — NOT design-reviewed · REFERENCE ONLY):** `reference/gallery.html#resume-template-panel`  — built from this spec’s own tokens and anatomy: token-pure, on the type ramp and gate-clean, but never checked against Figma, so its layout choices are guesses rather than decisions. **Ground on the spec above first.** Copy from the rendering ONLY where it agrees with what this spec actually states; where the spec is silent prefer a reviewed component from the escalation ladder (CLAUDE.md §2) over anything invented in it; where the two disagree the SPEC WINS and the difference goes to the design system author. Never describe work built on this as design-approved. In `reference/gallery.html` it lives in Part 3, closed by default.
...
**Tokens:** spacing.standard.lg  — class per token: see Token vocabulary
**Reference (DERIVED — NOT design-reviewed · REFERENCE ONLY):** `reference/gallery.html#consent-request-panel`  — built from this spec’s own tokens and anatomy: token-pure, on the type ramp and gate-clean, but never checked against Figma, so its layout choices are guesses rather than decisions. **Ground on the spec above first.** Copy from the rendering ONLY where it agrees with what this spec actually states; where the spec is silent prefer a reviewed component from the escalation ladder (CLAUDE.md §2) over anything invented in it; where the two disagree the SPEC WINS and the difference goes to the design system author. Never describe work built on this as design-approved. In `reference/gallery.html` it lives in Part 3, closed by default.
...
**Reference (DERIVED — NOT design-reviewed · REFERENCE ONLY):** `reference/gallery.html#reference-panel`  — built from this spec’s own tokens and anatomy: token-pure, on the type ramp and gate-clean, but never checked against Figma, so its layout choices are guesses rather than decisions. **Ground on the spec above first.** Copy from the rendering ONLY where it agrees with what this spec actually states; where the spec is silent prefer a reviewed component from the escalation ladder (CLAUDE.md §2) over anything invented in it; where the two disagree the SPEC WINS and the difference goes to the design system author. Never describe work built on this as design-approved. In `reference/gallery.html` it lives in Part 3, closed by default.
...
**Tokens:** spacing.standard.lg  — class per token: see Token vocabulary
**Reference (DERIVED — NOT design-reviewed · REFERENCE ONLY):** `reference/gallery.html#workflow-panel`  — built from this spec’s own tokens and anatomy: token-pure, on the type ramp and gate-clean, but never checked against Figma, so its layout choices are guesses rather than decisions. **Ground on the spec above first.** Copy from the rendering ONLY where it agrees with what this spec actually states; where the spec is silent prefer a reviewed component from the escalation ladder (CLAUDE.md §2) over anything invented in it; where the two disagree the SPEC WINS and the difference goes to the design system author. Never describe work built on this as design-approved. In `reference/gallery.html` it lives in Part 3, closed by default.
